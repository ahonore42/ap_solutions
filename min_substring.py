...
def min_substring(str_lst):
    ...
    def find_minimum(substring_list, initial_minimum):
        ...
        # Iterate upward through the list of found substrings
            ...
            # of the mimimum length (which is initially the length of the container_string)
        ...
        # After checking all substrings and finding the mimimum length substring, return the minimum length substring
    ...
    # Finally, return the mimimum length substring from our substrings list 
